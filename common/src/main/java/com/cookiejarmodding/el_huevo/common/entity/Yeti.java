...
{
    public static final AnimationState THROW_SNOWBALL = new AnimationState(53, new ResourceLocation(ElHuevo.MOD_ID, "yeti.setup"), new ResourceLocation(ElHuevo.MOD_ID, "yeti.throw_snowball"));
    public static final AnimationState ATTACK = new AnimationState(10, new ResourceLocation(ElHuevo.MOD_ID, "yeti.setup"), new ResourceLocation(ElHuevo.MOD_ID, "yeti.attack"));
//    public static final AnimationState[] CREATE_SNOWBALLS = new AnimationState[]{
//            new AnimationState(40, new ResourceLocation(ElHuevo.MOD_ID, "yeti.setup"), new ResourceLocation(ElHuevo.MOD_ID, "yeti.prepare_snowball")),
//            new AnimationState(60, new ResourceLocation(ElHuevo.MOD_ID, "yeti.setup"), new ResourceLocation(ElHuevo.MOD_ID, "yeti.prepare_snowball")),
//            new AnimationState(80, new ResourceLocation(ElHuevo.MOD_ID, "yeti.setup"), new ResourceLocation(ElHuevo.MOD_ID, "yeti.prepare_snowball")),
//            new AnimationState(100, new ResourceLocation(ElHuevo.MOD_ID, "yeti.setup"), new ResourceLocation(ElHuevo.MOD_ID, "yeti.prepare_snowball"))
//    };
    private static final AnimationState[] ANIMATIONS = Stream.of(THROW_SNOWBALL, ATTACK).toArray(AnimationState[]::new);
